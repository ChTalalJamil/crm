...
class AdminController extends Controller
{
    ...
    public function viewDashboard(){
        ...
        return view('admin.dashboard', compact('leads', 'accepted_lead_count', 'rejected_lead_count','total_leads'));
    ...
    public function getLeads()
    {
        ...
        return view('admin.components.leads-list', compact('leads', 'accepted_lead_count', 'rejected_lead_count','total_leads'));
    }
